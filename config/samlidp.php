...
return [
    ...
    // The SingleSignOnService Binding HTTP-Redirect or HTTP-POST
    ...
    // All the Laravel SAML IdP event / listener mappings.
    'events' => [
        'UnsaDev\SamlIdp\Events\Assertion' => [],
        'Illuminate\Auth\Events\Logout' => ['UnsaDev\SamlIdp\Listeners\SamlLogout'],
        'Illuminate\Auth\Events\Authenticated' => ['UnsaDev\SamlIdp\Listeners\SamlAuthenticated'],
        'Illuminate\Auth\Events\Login' => ['UnsaDev\SamlIdp\Listeners\SamlLogin'],
    ],
